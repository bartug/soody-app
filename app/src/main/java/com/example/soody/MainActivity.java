...
public class MainActivity extends AppCompatActivity {
    ...
    ImageView imageView,btnplay,imageView2;
    Button btnCamera , btnemo;
    TextView tv;
    Bitmap croppedbmp;
    ...
    private ImageView untitled_design_17__1;
    private ImageView untitled_design_18__1;
    ...
    private void initViews()
    {
      ...
      //  btnemo = (Button)findViewById(R.id.btnemo);
        ...
        untitled_design_17__1 = (ImageView) findViewById(R.id.untitled_design_17__1);
        untitled_design_18__1 = (ImageView) findViewById(R.id.untitled_design_18__1);
    ...
    private void detect()
    {
        Bitmap bitmap = ((BitmapDrawable)((ImageView)imageView2).getDrawable()).getBitmap();
