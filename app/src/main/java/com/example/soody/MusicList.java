...
public class MusicList extends AppCompatActivity {
    ...
    private void initviews() {
        ...
        textv.setText(mood + " Moduna Göre Soody Playlisti!");
        ...
        //        database = FirebaseDatabase.getInstance(firebaseApp, "https://[soodyapp]-default-rtdb.europe-west1.firebasedatabase.app/");
        //
